...
function validateRecipe(recipe) {
  if (!recipe.publisher) return 'Publisher is required.'
  if (!recipe.f2f_url) return 'f2f_url is required.'
  if (!recipe.title) return 'Title is required.'
  if (!recipe.source_url) return 'source_url is required.'
  if (!recipe.recipe_id) return 'recipe_id is required.'
  if (!recipe.image_url) return 'image_url is required.'
  if (!recipe.social_rank) return 'social_rank is required.'
  if (!recipe.publisher_url) return 'publisher_url is required.'
  return ''
}
